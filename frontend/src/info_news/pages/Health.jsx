...
export default function Health() {
	...
	useEffect(() => {
		const fetchArticles = async () => {
			try {
				...
				setError("Unable to load Health articles. Please try again.");
			} finally {
				setLoading(false);
			}
		};
	...
	// Render danh sách Health
	const renderArticlesList = () => (
		<>
			<h1 className="mb-4">Health</h1>
						...
						<div className="card-body d-flex align-items-center">
							...
							<div>
								<h3 className="card-title">
									Health topics, disease prevention, and wellness tips
								</h3>
								<p className="card-text">
									Explore articles on various health topics, disease prevention,
