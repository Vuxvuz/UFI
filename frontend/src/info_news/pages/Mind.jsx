...
export default function Mind() {
		...
		const fetchArticles = async () => {
			try {
				...
				if (response.data && response.data.data) {
					...
					setError("No Mental Health articles found.");
				}
			} catch (err) {
				console.error("Error fetching mental health articles:", err);
				setError("Unable to load Mental Health articles. Please try again.");
			} finally {
				setLoading(false);
			}
		};
	...
	// Render danh sách Mental Health
						...
						<div className="card-body d-flex align-items-center">
							...
							<div>
								...
								<p className="card-text">
									Learn about mental health conditions, treatments, and ways to
